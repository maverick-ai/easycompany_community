...
export default function Wrapper(props) {
  ...
  return (
    <div className={classes.wrapper}>
        ...
        <img src="../images/Tag_View/Wrapper/Dots2.png" alt="" className={classes.dots1} />
        <img src="../images/Tag_View/Wrapper/Dots.png" alt="" className={classes.dots2} />
        <img src="../images/Tag_View/Active_details/Star.png" alt="" className={classes.star1} />
        <img src="../images/Tag_View/Active_details/Star.png" alt="" className={classes.star2} />
        <img src="../images/Tag_View/Active_details/Star.png" alt="" className={classes.star3} />
