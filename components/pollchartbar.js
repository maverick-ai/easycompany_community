const PollChartBar = (props) => {
    ...
    return (
        <div style={{
            ...
            <div style={{transform:"rotate(-90deg)", width:"70px", marginTop:"275px", marginLeft:"-35px", marginRight:"-12px"}}>
                <span style={{fontSize:"14px"}}>{props.value} Votes</span>
            </div>
            <div style={{transform:"rotate(-90deg)", width:"70px", marginBottom:"295px", marginLeft:"-57px", marginRight:"-12px"}}>
